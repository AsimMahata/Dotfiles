...
--bind = $mainMod, M, exec, kitty -1 fish -c "cava"

--bind = $mainMod, M, exec, kitty --hold fastfetch
...
hl.bind(mainMod .. " + " .. "END", hl.dsp.exec_cmd("kitty -1 fish -c \"btop\""))

hl.bind(mainMod .. " + " .. "H", hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/help-window.py"))

hl.bind(mainMod .. " + " .. "B", hl.dsp.exec_cmd("python3 ~/.config/hypr/scripts/wallpaper-switcher.py"))
