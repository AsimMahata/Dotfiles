...
This guide documents the architecture, best practices, and hard-earned lessons for creating high-performance, crash-proof modals, popups, and dropdowns on Wayland (Hyprland / Sway) using **Python 3**, **GTK 3**, and **`GtkLayerShell`**.
